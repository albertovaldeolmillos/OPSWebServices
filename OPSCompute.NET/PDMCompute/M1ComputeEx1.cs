...
{
    public partial class M1ComputeEx1 : TariffCalculator
    {
        public const int INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_NO = 0;
        public const int INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_YES = 1;
        public const int INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_TRUNC = 2;

        private bool m_bApplyVehicleHistory;
        private bool m_bNotPrunedTreeInit;
        private M1ComputeEx1 m_pm1ComputeExAux;
        ...
        private int m_iCurrentAmountIntermediateValuePossible;
        ...
        private long m_lNumDaysPassed;
        private long m_lFirstTariff;
        ...
        private long GetCurrentSubTariff() {
            return m_lSubTariff;
        }
        private void SetCurrentSubTariff(long lSubTariff) {
            m_lSubTariff = lSubTariff;
        }
        ...
        public M1ComputeEx1(ILoggerManager loggerManager, int type) : base(type)
        {
            m_pDBB = null;
        ...
        private void ResetOper()
        {
            ...
            m_lSubTariff = GlobalDefs.DEF_UNDEFINED_VALUE;
            ...
            m_lRoundEndOfDayMoney = 0;
            m_lRoundEndOfDayRealMoney = 0;
            m_bRoundEndOfDayAmountIsAllowed = true;
            m_bCurrentAmountIsAllowed = true;
            m_iCurrentAmountIntermediateValuePossible = INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_YES;
            ...
            m_lNumDaysPassed = 0;
            m_lFirstTariff = GlobalDefs.DEF_UNDEFINED_VALUE;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::GetM1");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::SetInput");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::Compute");
            bool fnResult = true;
            ...
            try
            {
                ...
                if (m_lResult == M1_OP_OK)
                {
                    ...
                    if (m_pm1ComputeExAux == null)
                    {
                        try
                        {
                            m_pm1ComputeExAux = new M1ComputeEx1(trace.Creator, this.Type);
                        }
                        catch (Exception)
                        {
                    ...
                    do
                    {
                        ...
                        if (m_lResult == M1_OP_OK)
                        {
                            if (!GetTree().GetBranchMaxAvailableMinutes(m_lGroupId, ref lMinutes, isComputeEx1 : true))
                            {
                        ...
                        if (m_lResult == M1_OP_OK)
                        {
                            if (!GetTree().GetBranchMaxAvailableMoney(m_lGroupId, ref lMoney, isComputeEx1: true))
                            {
                        ...
                        if (m_lResult == M1_OP_OK)
                        {
                            if (!GetTree().GetBranchMaxAvailableMinutes(GetGroupId(), ref lMinutes, isComputeEx1: true))
                                throw new InvalidOperationException("Could not obtain branch available minutes");
                        ...
                        if (m_lResult == M1_OP_OK)
                        {
                            if (!GetTree().GetBranchMaxAvailableMoney(GetGroupId(), ref lMoney, isComputeEx1: true))
                            {
                                throw new InvalidOperationException("Could not obtain branch available minutes");
                            }
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::AddMinutesToDate");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::AddMoneyToDate");
            bool fnResult = true;
            ...
            try
            {
                ...
                m_pm1ComputeExAux.ApplyVehicleHistory(m_bApplyVehicleHistory);
                m_pm1ComputeExAux.IgnoreResets();
                // VEHICLE PLATE: If it exists we must apply history (except for a return operation)
                ...
                trace.Write(TraceLevel.Info, "ADD MONEY TO DATE SET OUPTUP");
                if (!m_pm1ComputeExAux.SetOutput(pM1, false))
                {
                    throw new InvalidOperationException("Could not set output data");
                }
        ...
        protected void IgnoreResets() { m_bIgnoreResets = true; }
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::ComputeReturn");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::ComputeTariff");
            bool fnResult = true;
            ...
            try
            {
                ...
                if (m_lResult == M1_OP_OK)
                {
                    ...
                    if (!GetTree().SetInitialIntervalOffset(GetGroupId(), ref m_stInitialIntervalOffset, isComputeEx1 : true))
                    {
                    ...
                    if (m_lRealCurrMinutes == 0 && !bM1Plus && !bChangeTariff)
                    {
                        m_lResult = M1_OP_TPERM;
                    }
                }
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::IterateDay");
            bool fnResult = true;
            ...
            try
            {
                ...
                if (!bDayChange)
                {
                    ...
                    lTariff = GetCurrentTariff();
                    bBlockFound = false;
                    if (!m_pDBB.ExistTariffBlock(lTariff, dayTypes , dtOper, ref bBlockFound, m_bConsiderCloseFirstInterval))
                    {
                        throw new InvalidOperationException("Error in call to m_pPDMDB->ExistTariffBlock");
                    }

                    if (!bBlockFound)
                    {
                        lTariff = GlobalDefs.DEF_UNDEFINED_VALUE;
                    ...
                    if ( lTariff == GlobalDefs.DEF_UNDEFINED_VALUE)
                    {
                    ...
                    else
                    {
                        ...
                        if (!m_pDBB.GetTariffBlock(lTariff, ref dayTypes, ref dtOper, m_lNumDaysPassed, ref lBlockID, ref lBlockIni, ref lBlockEnd, ref lSubTariff, ref bBlockFound,
                        ...
                        if (bBlockFound)
                        {
                            ...
                            {
                                throw new InvalidOperationException("Error in call to CM1ComputeEx1::GetBranchState");
                            }
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::IterateBlockIntervals");
            bool fnResult = true;
            ...
            try
            {
                ...
                {
                    bool bResetForSubTariffChange = false;

                    if (GetCurrentSubTariff() != lSubTariff)
                    {
                        if (GetCurrentSubTariff() != GlobalDefs.DEF_UNDEFINED_VALUE)
                        {

                            stIntervalOffset.iTime = 0;
                            stIntervalOffset.iMoney = 0;
                            bResetForSubTariffChange = true;
                        }

                        SetCurrentSubTariff(lSubTariff);
                    }
                    ...
                    if (!bStop)
                    {
                        ...
                        if (!MoneyToTime(lOpMoney, ref lOpMinutes, ref stIntervalOffset, ref lstIntervals, ref lMinutesWithZeroValue, ref m_bCurrentAmountIsAllowed, ref m_iCurrentAmountIntermediateValuePossible))
                    ...
                    if (lTimeLimit != GlobalDefs.DEF_UNDEFINED_VALUE)
                    {
                        if ((lOperTime + lOpMinutes) >= lTimeLimit)
                        {
                            ...
                            if (!TimeToMoney(lOpMinutes, ref lOpMoney, ref stIntervalOffset, ref lstIntervals, ref m_bCurrentAmountIsAllowed, ref m_iCurrentAmountIntermediateValuePossible))
                            {
                    ...
                    if (!CheckBlockEnd(lOperTime, lOperMoney, lBlockIni, lBlockEnd, ref lOpMinutes, ref lOpMoney,
                                        ...
                                        ref m_bCurrentAmountIsAllowed, ref m_iCurrentAmountIntermediateValuePossible, ref lMaxAmountAllowed,
                    ...
                    if ((bResetForSubTariffChange) && (lOpMinutes > 0))
                    {
                        m_lTariffMoney = 0;
                        m_bIntReset = true;
                        m_lCurrMinutes = 0;
                ...
                bJumpNextBlock = bJumpNextBlock && ((m_lTariffMoney < GetMaxMoney()) || (GetMaxMoney() == 0) || (lOpMoney > 0));
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::ChangeBlock");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::DetectResets");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::CalculateQuantitySteps");
            bool fnResult = true;
            ...
            try
            {
                ...
                long lMinutes = 0;
                long lMinutesWithZeroValue = 0;
                int iCurrentAmountIntermediateValuePossible = 0;
                ...
                if (m_lCalculateSteps_CurrentValue != GlobalDefs.DEF_UNDEFINED_VALUE)
                {
                    while ((m_lCalculateSteps_CurrentValue) <= (m_lRealCurrMoney + lOpMoney))
                    {
                        ...
                        if (!MoneyToTime(pstStepCalculation.lMoney - m_lRealCurrMoney, ref lMinutes, ref stIntervalOffset, ref lstIntervals, ref lMinutesWithZeroValue, ref bCurrentAmountIsAllowed, ref iCurrentAmountIntermediateValuePossible))
                        {
                            throw new InvalidOperationException("Could not get offset money");
                        }
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::CalculateTimeSteps");
            bool fnResult = true;
            ...
            try
            {
                ...
                if (m_lCalculateSteps_CurrentValue == GlobalDefs.DEF_UNDEFINED_VALUE)
                {
                    if ((m_lRealCurrMoney + lOpMoney) >= GetMinMoney())
                    {
                        ...
                        if (!MoneyToTime(lMinMoney, ref lMinutes, ref stOffsetInterval, ref lstIntervals, ref lMinutesWithZeroValue, ref bCurrentAmountIsAllowed, ref iCurrentAmountIntermediateValuePossible))
                        {
                            throw new InvalidOperationException("Could not get offset money");
                        }
                ...
                if (m_lCalculateSteps_CurrentValue != GlobalDefs.DEF_UNDEFINED_VALUE)
                {
                    while ((m_lCalculateSteps_CurrentValue) <= (m_lRealCurrMinutes + lOpMinutes))
                    {
                        ...
                        if (!TimeToMoney(pstStepCalculation.lMinutes - m_lRealCurrMinutes, ref lMoney, ref stOffsetInterval, ref lstIntervals, ref bCurrentAmountIsAllowed, ref iCurrentAmountIntermediateValuePossible))
                        {
                            throw new InvalidOperationException("Could not get offset money");
                        }
                        ...
                        if (!MoneyToTime(lMoney, ref lMinutes, ref stOffsetInterval, ref lstIntervals, ref lMinutesWithZeroValue, ref bCurrentAmountIsAllowed, ref iCurrentAmountIntermediateValuePossible))
                        {
                            throw new InvalidOperationException("Could not get offset money");
                        }
        ...
        private bool CheckBlockEnd(long lOperTime, long lOperMoney, long lBlockIni, long lBlockEnd,
                                    ...
                                    ref int  piCurrentAmountIntermediateValuePossible,
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::CheckBlockEnd");
            bool fnResult = true;
            ...
            try
            {
                ...
                if ((lOperTime + lOpMinutes) >= lBlockEnd)
                {
                    ...
                    if (!TimeToMoney(lOpMinutes, ref lOpMoney, ref stIntervalOffset, ref lstIntervals, ref bCurrentAmountIsAllowed, ref piCurrentAmountIntermediateValuePossible))
                    {
                        throw new InvalidOperationException("Could not get offset money");
                    }
                }
                ...
                int iCurrentAmountIntermediateValuePossible = INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_NO;
                ...
                if (!bCurrentAmountIsAllowed)
                {
                    ...
                    {
                        if (!TimeToMoney(lCurrMinutes, ref lCurrMoney, ref stIntervalOffset, ref lstIntervals, ref bCurrCurrentAmountIsAllowed, ref iCurrentAmountIntermediateValuePossible))
                        {
                            throw new InvalidOperationException("Could not get offset money");
                        }
                    ...
                    if (bCurrCurrentAmountIsAllowed)
                    {
                        ...
                        if (!MoneyToTime(lCurrMoney, ref lCurrMinutes, ref stIntervalOffset, ref lstIntervals, ref lMinutesWithZeroValueTemp, ref bCurrCurrentAmountIsAllowed, ref iCurrentAmountIntermediateValuePossible))
                        {
                            throw new InvalidOperationException("Could not get offset money");
                        }
                ...
                if (bCalculateMinAllowed && (lTimeForMaxAmountAllowed != GlobalDefs.DEF_UNDEFINED_VALUE))
                {
                    ...
                    if (bCurrCurrentAmountIsAllowed)
                    {
                        ...
                        if (!MoneyToTime(lCurrMoney, ref lCurrMinutes, ref stIntervalOffset, ref lstIntervals, ref lMinutesWithZeroValueTemp,
                            ref bCurrCurrentAmountIsAllowed, ref iCurrentAmountIntermediateValuePossible))
                        {
                            throw new InvalidOperationException("Could not get offset money");
                        }
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::CheckMaxTime");
            bool fnResult = true;
            ...
            try
            {
                ...
                if ((m_lTimeLimit != GlobalDefs.DEF_UNDEFINED_VALUE) && (!m_bPostPay))
                {
                    if ((lOpMinutes) + m_lRealCurrMinutes > m_lTimeLimit)
                    {
                        ...
                        if (!TimeToMoney(lOpMinutes, ref lOpMoney, ref stIntervalOffset, ref lstIntervals, ref bCurrentAmountIsAllowed, ref iCurrentAmountIntermediateValuePossible))
                        {
        ...
        private bool TimeToMoney(long lOpMinutes, ref long lOpMoney, ref stINTERVAL stIntervalOffset, ref List<stINTERVAL> lstIntervals, ref bool bCurrentAmountIsAllowed, ref int piCurrentAmountIntermediateValuePossible)
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::TimeToMoney");
            bool fnResult = true;
            ...
            try
            {
                ...
                bCurrentAmountIsAllowed = true;
                piCurrentAmountIntermediateValuePossible = INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_YES;
                ...
                foreach (stINTERVAL interval in lstIntervals)
                {
                    ...
                    if (stLastInterval.iTime <= (int)lOpMinutes * 60 && (int)lOpMinutes * 60 < stCurrentInterval.iTime)
                    {
                        ...
                        {
                            bCurrentAmountIsAllowed = (stCurrentInterval.iIntervalIntermediateValuesPossible == INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_YES);
                        }
                        else
                        {
                            bCurrentAmountIsAllowed = true;
                        ...
                        piCurrentAmountIntermediateValuePossible  = (int)stCurrentInterval.iIntervalIntermediateValuesPossible;
                        break;
                    }
                    else if ((int)lOpMinutes * 60 < stCurrentInterval.iTime)
                    {
                        ...
                        if (lOpMoney < stCurrentInterval.iMoney)
                        {
                            bCurrentAmountIsAllowed = (stCurrentInterval.iIntervalIntermediateValuesPossible == INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_YES);
                        }
                        else
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::CheckMaxMoney");
            bool fnResult = true;
            ...
            try
            {
                ...
                if (lOperMoney + m_lCurrMoney > GetMaxMoney())
                {
                    ...
                    if (!MoneyToTime(lMoney, ref lOpMinutes, ref stIntervalOffset, ref lstIntervals, ref lTemp, ref bCurrentAmountIsAllowed, ref iCurrentAmountIntermediateValuePossible))
                    {
                        throw new InvalidOperationException("Could not find minutes");
                    }
        ...
        //
        private bool MoneyToTime(long lMoney, ref long lOpMinutes, ref stINTERVAL stIntervalOffset, ref List<stINTERVAL> lstIntervals, ref long plMinutesWithZeroValue, ref bool bCurrentAmountIsAllowed, ref int piCurrentAmountIntermediateValuePossible)
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::MoneyToTime");
            bool fnResult = true;
            ...
            try
            {
                ...
                foreach (stINTERVAL interval in lstIntervals)
                {
                    ...
                    if (stLastInterval.iMoney <= lMoney && lMoney < stCurrentInterval.iMoney)
                    {
                        ...
                        bCurrentAmountIsAllowed = ((stCurrentInterval.iIntervalIntermediateValuesPossible == INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_YES) || (stLastInterval.iMoney == lMoney));
                        piCurrentAmountIntermediateValuePossible = (int)stCurrentInterval.iIntervalIntermediateValuesPossible;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::Interpolate");
            bool fnResult = true;
        ...
        private bool TraceIntervals(List<stINTERVAL> lstIntervals)
        {
            ...
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::TraceIntervals");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::GetBranchState");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::SetOutput");
            bool fnResult = true;

            COPSDate dtOper;
            COPSPlate strPlate;
            long lImport = 0;
            bool bBackupCurrentAmountIsAllowed;
                ...
                switch (GetOperType())
                {
                    case OperationDat.DEF_OPERTYPE_AMP:
                        ...
                        else if ((!m_bRoundEndOfDay) && (!m_bCurrentAmountIsAllowed))
                        {
                            ...
                            {
                                if ((m_lLastAllowedAmountRealMinutes != GlobalDefs.DEF_UNDEFINED_VALUE) &&
                                    ((m_lRealCurrMoney == m_lLastAllowedAmountRealMoney) || (m_iCurrentAmountIntermediateValuePossible == INTERVAL_INTERMEDIATE_POSSIBLE_VALUES_TRUNC)))
                                {
                                    pM1.SetOutOperDateEnd(GetLastAllowedAmountEndDate());
                                    m_lRealCurrMinutes = m_lLastAllowedAmountRealMinutes;
                                    m_lCurrMinutes = m_lLastAllowedAmountMinutes;
                        ...
                        {
                            m_bCurrentAmountIsAllowed = (m_bRoundEndOfDayAmountIsAllowed && (m_lRoundEndOfDayRealMoney == m_lRealCurrMoney));
                            ...
                            m_lRealCurrMoney = m_lRoundEndOfDayRealMoney;
                            m_lCurrMoney = m_lRoundEndOfDayMoney;
                        }
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::GetRoundUpMoney");
            long fnResult = 0;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::ApplyHistory");
            bool fnResult = true;
            ...
            CM1GroupsTree oTreeForCalculatingMax = null;
            CM1GroupsTree pTreeSecond = null;
            long lCurrentSubtariff = GlobalDefs.DEF_UNDEFINED_VALUE;
            COPSDate dtInitialDate = new COPSDate();
            COPSDate dtEndDate = new COPSDate();
            long lFirstTariff=  GlobalDefs.DEF_UNDEFINED_VALUE;
            bool bCurrTimeReset = false;
            ...
            try
            {
                ...
                dtInitialDate.SetStatus(COPSDateStatus.Invalid);
                dtEndDate.SetStatus(COPSDateStatus.Invalid);
                ...
                while (operationsIndex < operationsCount && !bExit)
                {
                    ...
                    else if (operation.OPE_DOPE_ID == OperationDat.DEF_OPERTYPE_PARK || operation.OPE_DOPE_ID == OperationDat.DEF_OPERTYPE_AMP || operation.OPE_DOPE_ID == OperationDat.DEF_OPERTYPE_RETN)
                    {
                        ...
                        if (!bRemoteReturn)
                        {
                            ...
                            trace.Write(TraceLevel.Info, $"ANTES Corrected Operation: {operation.OPE_ID}");
                            trace.Write(TraceLevel.Info, $"A[ {"Operation",-9} | {"Date",-21} | {"Op. Type",-8} | {"Group",-7} | {"IniDate",-21} | {"EndDate",-21} | {"Op.Money",-8} | {"Op.Time",-8} | {"Pay. Tipe",-8} | {"Time Reset",-9} | {"Less Max Ree Time",-21} ]");
                            trace.Write(TraceLevel.Info, $"A[ {operation.OPE_ID,-9} | {operation.OPE_MOVDATE?.fstrGetTraceString(),-21} | {operation.OPE_DOPE_ID,-8} | {operation.OPE_GRP_ID,-7} | {operation.OPE_INIDATE?.fstrGetTraceString(),-21} | {operation.OPE_ENDDATE?.fstrGetTraceString(),-21} | {operation.OPE_VALUE,-8} | {operation.OPE_DURATION,-8} | {operation.OPE_DPAY_ID,-8} | {bTimeReset,-9} | {bLessMaxInterdateReeTime,-21} ]");

                            if (!CorrectOperationData(GetTree(), m_strVehicleId, m_lArticleDef, ref dtBackOpIni, ref dtBackOpEnd, ref operation,
                                                      ref lRealAccMoney, ref lRealAccTime, ref bTimeReset, ref bLessMaxInterdateReeTime, ref bDiscardOp,ref lCurrentSubtariff,
                                                      ref lInitialTimeLastInterval, ref m_lEndTimeLastInterval, ref lCurrentTimeLastInterval, ref lFirstTariff))
                            {
                            ...
                            if (!bDiscardOp && (operation.OPE_INIDATE < operation.OPE_ENDDATE))
                            {
                                ...
                                if (iHistoryRes == (int)M1GroupState.GRP_ON)
                                {
                                    ...
                                    if (!ApplyHistoryBranch(GetTree(), pTreeSecond, operation, lRealAccMoney, lRealAccTime,  bLessMaxInterdateReeTime, ref bChainedOperation))
                                    {
                                ...
                                else
                                {
                                    ...
                                    if ((!bExit) && (bChainedOperation))
                                    {
                                        if (!bCurrTimeReset)
                                        {
                                            GetTree().GetBranchEfecAccumMoney(GetGroupId(), ref m_lRealAccMoney);
                                            GetTree().GetBranchEfecAccumMinutes(GetGroupId(), ref m_lRealAccMinutes);
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                SetCurrentSubTariff(lCurrentSubtariff);
                                                ...
                                                dtInitialDate = dtRealOpIni.Copy(); // REVIEW IF THIS DATE COPY IS OK 
                                                dtEndDate = dtRealOpEnd.Copy();     // REVIEW IF THIS DATE COPY IS OK 
                                            }
                                            else
                                            {
                                                dtInitialDate = dtRealOpIni.Copy(); // REVIEW IF THIS DATE COPY IS OK 
                                            ...
                                            m_lFirstTariff = lFirstTariff;
                                            SetCurrentTariff(m_lFirstTariff);
                                        }
                                    }

                                    if ((!bCurrTimeReset) && (bTimeReset))
                                    {
                                        bCurrTimeReset = bTimeReset;
                                        oTreeForCalculatingMax = new CM1GroupsTree(this.trace.Creator);
                                        if (oTreeForCalculatingMax == null)
                                            throw new InvalidOperationException("Error allocating memory for oTreeForCalculatingMax");

                                        oTreeForCalculatingMax.Copy(GetTree());
                                        pTreeSecond = GetTree();
                                        this.m_Tree = oTreeForCalculatingMax;
                                        bExit = false;
                ...
                if ((dtInitialDate.GetStatus() == COPSDateStatus.Valid) && (dtEndDate.GetStatus() == COPSDateStatus.Valid))
                {
                    GetNumOfPassedDays(dtInitialDate, dtEndDate, ref m_lNumDaysPassed);
                }
                ...
                GetTree().TraceBranchM1ComputeEx1(GetGroupId());
            }
            catch (Exception error)
            {
                trace.Write(TraceLevel.Error, error.ToLogString());
        ...
        private bool ApplyHistoryBranch(CM1GroupsTree tree, CM1GroupsTree treeSecond, Operations operation, long operationRealMoney, long operationRealTime, bool bLessMaxInterdateReeTime, ref bool bChainedOperation)
        {
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::ApplyHistoryBranch");
            bool fnResult = true;
            ...
            try
            {
                ...
                CM1Group pGrpSecond = null;
                if (treeSecond != null)
                {
                    pGrpSecond = treeSecond.GetGroupFromGrpId(operation.OPE_GRP_ID.GetValueOrDefault());
                }
                ...
                {
                    if (!EvaluateHistoryConstraints(group, operation, operationRealMoney, operationRealTime,  bLessMaxInterdateReeTime, ref bChainedOperation))
                    {
                    ...
                    while ((group != null) && (group.GetState() != (long)M1GroupState.GRP_REE))
                    {
                        if (pGrpSecond != null)
                        {
                            pGrpSecond.AddRealMoney(group.GetRealAccMoney() - pGrpSecond.GetRealAccMoney());
                        }
                        ...
                        else
                        {
                            ...
                            if (group.GetState() == (long)M1GroupState.GRP_ON)
                            {
                                ...
                                if (treeSecond != null)
                                {
                                    pGrpSecond = treeSecond.GetGroupFromGrpId(lGrpId);
                                }
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::ApplyRemoteHistory");
            bool fnResult = true;
            ...
            try
            {
                ...
                else
                {
                    ...
                    pWorkGrp.AddEfecMoney(m_lAccMoney);
                    pWorkGrp.AddEfecTime(m_lAccMinutes);
                    ...
                    else
                    {
                        ...
                        pParentGrp.AddEfecMoney(m_lAccMoneyGroup);
                        pParentGrp.AddEfecTime(m_lAccMinutesGroup);
                    }
                }

                tree.TraceBranchM1ComputeEx1(GetGroupId());
            }
            catch (Exception error)
            {
                trace.Write(TraceLevel.Error, error.ToLogString());
        ...
        /// <returns></returns>
        private bool EvaluateHistoryConstraints(CM1Group group, Operations operation, long opRealMoney, long opRealTime,
                                                bool bLessMaxInterdateReeTime, ref bool bChainedOperation)
        {
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::EvaluateHistoryConstraints");
            bool fnResult = true;
                    ...
                    else
                    {
                        ...
                        if ((bIntraZoneCourtesy) || (bOpGroupInGroupTree))
                        {
                            if (((bPostPay) && (!bCourtesy)) || (m_bPostPay))
                            {
                                ...
                                long lNewTime = group.GetEfecAccMinutes() + operation.OPE_DURATION.GetValueOrDefault() + lPostPayMinutes;
                            ...
                            if (((bCourtesy) || (bPostPay)) &&/*(!bHistOpPostPay)&&*/(group.GetState() == (long)M1GroupState.GRP_ON))
                            {
                                ...
                                trace.Write(TraceLevel.Info, $"Adding Efec money: {operation.OPE_VALUE}");
                                group.AddEfecMoney(operation.OPE_VALUE.GetValueOrDefault());

                                trace.Write(TraceLevel.Info, $"Adding Efec minutes: {operation.OPE_DURATION}");
                                group.AddEfecTime(operation.OPE_DURATION.GetValueOrDefault());

                                trace.Write(TraceLevel.Info, $"Adding Real money: {opRealMoney}");
                                group.AddRealMoney(opRealMoney);

                                trace.Write(TraceLevel.Info, $"Adding Real minutes: {opRealTime}");
                                group.AddRealTime(opRealTime);
        ...
        {
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::EvaluateReentry");
            bool fnResult = true;
        ...
        private bool EvaluatePostPayTime(CM1Group group, COPSDate dtGrpLast, COPSDate pdtEnd, bool bTimeReset, ref bool bPostPay, ref long lPostPayTime)
        {
            ...
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::EvaluatePostPayTime");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::EvaluateIntraZoneCourtesy");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::EvaluateCourtesy");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::EvaluateIntraZonePark");
            bool fnResult = true;
        ...
        private bool CorrectOperationData(CM1GroupsTree pTree, COPSPlate vehicleId, long lArticleDef, ref COPSDate dtBackOpIni, ref COPSDate dtBackOpEnd, ref Operations operation,
                                            ref long lRealAccMoney, ref long lRealAccTime, ref bool bTimeReset, ref bool bLessMaxInterdateReeTime, ref bool bDiscardOp, ref long plCurrentSubtariff,  ref long lInitialTimeLastInterval,
                                            ref long m_lEndTimeLastInterval, ref long lCurrentTimeLastInterval, ref long plFirstTariff)
        {
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::CorrectOperationData");
            bool fnResult = true;
            ...
            try
            {
                ...
                if (!bDiscardOp)
                {
                    ...
                    {
                        m_pm1ComputeExAux.SetMoney(operation.OPE_VALUE.GetValueOrDefault());
                    }
                    // VEHICLE PLATE: If it exists we must apply history (except for a return operation)
                    ...
                    if (((operation.OPE_VALUE.GetValueOrDefault()) <= 0) || (operation.OPE_DOPE_ID == OperationDat.DEF_OPERTYPE_RETN))
                    {
                    ...
                    ExistTimeResetBetweenDates(operation.OPE_INIDATE, operation.OPE_ENDDATE, ref bTimeReset);
                    ...
                    plCurrentSubtariff = m_pm1ComputeExAux.GetCurrentSubTariff();
                    ...
                    plFirstTariff = m_pm1ComputeExAux.m_lFirstTariff;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::CorrectOperationDates");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::ApplyConstraintsEx");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::GetConstraintsAndTariff");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::BuildGroupsTree");
            bool fnResult = true;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (m_lFirstTariff == GlobalDefs.DEF_UNDEFINED_VALUE)
                    {
                        m_lFirstTariff = lTariff;
                    }
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::FillTree");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::PruneTree");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::CheckInput");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "M1ComputeEx1::CheckArticle");
            bool fnResult = true;
        ...
        {
            trace.Write(TraceLevel.Debug, "CM1ComputeEx1::CheckGroup");
            bool fnResult = true;
        ...
        private bool GetNumOfPassedDays(COPSDate pdtDate1, COPSDate pdtDate2,ref  long plNumPassedDays)
        {

            trace.Write(TraceLevel.Debug, "GetNumOfPassedDays");
            bool fnResult = true;
            ...
            try
            {
                ...
                plNumPassedDays = m_pm1ComputeExAux.m_lNumDaysPassed;
            }
            catch (Exception error)
            {
                trace.Write(TraceLevel.Error, error.ToLogString());
