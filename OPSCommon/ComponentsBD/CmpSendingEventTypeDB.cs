...
namespace OPS.Components.Data
{
	...
	/// </summary>
	public class CmpSendingEventTypeDB : CmpGenericBase
	{
		public CmpSendingEventTypeDB() 
		{
			...
			_standardPks		= new string[]  {"TEV_ID"};
			_standardTableName	= "SENDING_EVENT_TYPE";
			_standardOrderByField	= "TEV_ID";
