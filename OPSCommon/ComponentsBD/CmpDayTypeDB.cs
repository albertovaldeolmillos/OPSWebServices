...
//	/// CmpDayTypeDB
//	/// </summary>
//	public class CmpDayTypeDB: CmpBase
//	{
...
//			da.UpdateCommand = d.PrepareCommand ("UPDATE DAYS_DEF SET DDAY_DESCSHORT = @DAYS_DEF.DDAY_DESCSHORT@, DDAY_DESCLONG = @DAYS_DEF.DDAY_DESCLONG@, DDAY_CODE = @DAYS_DEF.DDAY_CODE@ WHERE DDAY_ID = @DAYS_DEF.DDAY_ID@", false);
