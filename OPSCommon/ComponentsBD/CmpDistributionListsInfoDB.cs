...
namespace OPS.Components.Data
{
	...
	/// </summary>
	public class CmpDistributionsListsInfoDB : CmpGenericBase
	{
		public CmpDistributionsListsInfoDB() 
		{
			...
			_standardPks		= new string[]  {"DLI_ID"};
			_standardTableName	= "DISTRIBUTION_LISTS_INFO";
			_standardOrderByField	= "DLI_ID";
